...
import { TToastType } from './toaster.interface';
import { DnbhubToasterService, toasterServiceProvider } from './toaster.service';

describe('DnbhubToasterService', () => {
  ...
  let service: DnbhubToasterService;
  ...
  beforeEach(
    waitForAsync(() => {
      void TestBed.configureTestingModule(testBedConfig)
        .compileComponents()
        .then(() => {
          service = TestBed.inject(DnbhubToasterService);
